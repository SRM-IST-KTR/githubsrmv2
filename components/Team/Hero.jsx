            ...
            <div className='bg-black/40 py-8 md:py-16 lg:py-16'>
                <div className="flex justify-start items-center relative z-10">
                    <div className="text-left">
                        <h1 className=" font-poppins text-5xl font-bold mt-10 xl:mt-20 md:mt-20 px-8 lg:px-60 text-white">
                            Our <span className="text-bright_green">Team</span>
                        </h1>
                        <br />
                        <p className="lg:text-2xl text-lg font-semibold px-8 lg:px-60 text-justify text-white font-dmSans">
