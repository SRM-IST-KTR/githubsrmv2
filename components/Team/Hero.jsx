                ...
                <div className="flex justify-start items-center relative z-10">
                    <div className="text-left">
                        ...
                        <p className="mt-4 lg:text-2xl md:text-lg font-medium px-8 lg:px-60 text-left text-white font-dmSans">
                            ...
                            innovation in areas ranging from open-source
                            contributions to cutting-edge tech projects. Meet
                            our dedicated team members, explore their expertise,
                            and learn about the exciting projects they're
                            working on. Whether you're interested in coding,
                            design, or community engagement, find your niche and
                            connect with like-minded enthusiasts on our Teams
                            page. Join us in shaping the future of technology at
                            GitHub SRM!
                        </p>
                        <br />
                        <br />
