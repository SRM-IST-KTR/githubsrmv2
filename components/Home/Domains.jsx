        ...
        <div className="p-20">
            ...
            <section className="domain-box container flex">
                <div class="grid grid-cols-2 gap-6 text-center p-20">
                    <div className="">
                        <div className="drop-shadow-glow filter tech-click bg-domain_bg rounded-xl p-6 shadow-lg text-white h-[247px] w-[236px] flex flex-col justify-center items-center">
                            <div>
                                <svg
                                    width="101"
                                    height="101"
                    ...
                    <div className="drop-shadow-glow filter bg-domain_bg rounded-xl p-6 shadow-lg text-white h-[247px] w-[236px] flex flex-col justify-center items-center">
                        <div>
                            <svg
                                width="108"
                                height="107"
                    ...
                    <div className="drop-shadow-glow filter bg-domain_bg rounded-lg p-6 shadow-lg text-white h-[247px] w-[236px] flex flex-col justify-center items-center">
                        <div>
                            <svg
                                width="101"
                                height="101"
